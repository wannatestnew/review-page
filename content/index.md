...
This is my central hub for notes and thoughts, built with Obsidian and Quartz.
...
- [[AI/index|AI]] — 大语言模型和智能体 | Large language models and agents
- [[technology/index|Technology]] — 硬件和系统设置 | Hardware and system setups
- [[programming/index|Programming]] — 语言、脚本和逻辑 | Languages, scripts, and logic
...
| 教程 | 说明 |
|------|------|
| [[programming/2026-03-01-learn-json-format|JSON 文件格式入门教程]] | 数据交换格式基础 |
| [[programming/2026-03-01-learn-git-basics|Git 基础教程]] | 版本控制入门 |
| [[programming/2026-03-01-learn-markdown-basics|Markdown 入门教程]] | 文档编写格式 |
| [[programming/2026-03-01-openclaw-config-guide|OpenClaw 配置文件说明]] | 系统配置说明 |
