---
title: "In 2026, AI will move from hype to pragmatism (中文翻译)"
date: 2026-01-02
tags: [ai, web-clip, 中文翻译]
source: https://techcrunch.com/2026/01/02/in-2026-ai-will-move-from-hype-to-pragmatism/
category: AI
lang: zh
translation_source: "2026-01-02-in-2026-ai-will-move-from-hype-to-pragmatism"
translator: "GLM-5 (z-ai/glm5)"
---

> 🌐 **English Version**: [[2026-01-02-in-2026-ai-will-move-from-hype-to-pragmatism|Read original English version]]
# In 2026, AI will move from hype to pragmatism

Title: In 2026, AI will move from hype to pragmatism

URL Source: https://techcrunch.com/2026/01/02/in-2026-ai-will-move-from-hype-to-pragmatism/

Published Time: 2026-01-02T14:43:00+00:00

Markdown Content:
If 2025 was the year [AI got a vibe check](https://techcrunch.com/2025/12/29/2025-was-the-year-ai-got-a-vibe-check/), 2026 will be the year the tech gets practical. The focus is already shifting away from building ever-larger language models and toward the harder work of making AI usable. In practice, that involves deploying smaller models where they fit, embedding intelligence into physical devices, and designing systems that integrate cleanly into human workflows.
...
![Image 1: Amazon data center](https://techcrunch.com/wp-content/uploads/2025/11/amazon-data-center.png?w=680)

**Image Credits:**Amazon

In 2012, Alex Krizhevsky, Ilya Sutskever, and Geoffrey Hinton’s [ImageNet paper](https://proceedings.neurips.cc/paper_files/paper/2012/file/c399862d3b9d6b76c8436e924a68c45b-Paper.pdf) showed how AI systems could “learn” to recognize objects in pictures by looking at millions of examples. The approach was computationally expensive, but made possible with GPUs. The result? A decade of hardcore AI research as scientists worked to invent new architectures for different tasks.
...
Yann LeCun, Meta’s [former chief AI scientist](https://techcrunch.com/2025/11/11/metas-chief-ai-scientist-yann-lecun-reportedly-plans-to-leave-to-build-his-own-startup/), has long argued against the overreliance on scaling, and stressed the need to develop better architectures. And Sutskever said in a recent [interview](https://www.dwarkesh.com/p/ilya-sutskever-2) that current models are plateauing and pretraining results have flattened, indicating a need for new ideas.
...
![Image 2: Space ship environment created in Marble with text prompt overlayed. Note how the lights are realistically reflected in the hub's walls.](https://techcrunch.com/wp-content/uploads/2025/11/Untitled-design.png?w=680)
...
Signs that 2026 will be a big year for world models are multiplying. LeCun left Meta to start his own world model lab and is reportedly [seeking a $5 billion valuation](https://techcrunch.com/2025/12/19/yann-lecun-confirms-his-new-world-model-startup-reportedly-seeks-5b-valuation/). Google’s DeepMind has been plugging away at Genie and in August launched its latest model that builds real-time interactive general-purpose world models. Alongside demos by startups like [Decart](https://techcrunch.com/2024/10/31/decarts-ai-simulates-a-real-time-playable-version-of-minecraft/) and [Odyssey](https://techcrunch.com/2025/05/28/odysseys-new-ai-model-streams-3d-interactive-worlds/), [Fei-Fei Li’s World Labs](https://techcrunch.com/2025/11/12/fei-fei-lis-world-labs-speeds-up-the-world-model-race-with-marble-its-first-commercial-product/) has launched its first commercial world model, Marble. Newcomers like General Intuition in October scored a [$134 million seed round](https://techcrunch.com/2025/10/16/general-intuition-lands-134m-seed-to-teach-agents-spatial-reasoning-using-video-game-clips/) to teach agents spatial reasoning, and video generation startup Runway in December released its [first world model, GWM-1](https://techcrunch.com/2025/12/11/runway-releases-its-first-world-model-adds-native-audio-to-latest-video-model/?_thumbnail_id=3075173).
...
![Image 3](https://techcrunch.com/wp-content/uploads/2026/01/igor-omilaev-gVQLAbGVB6Q-unsplash.jpg?w=680)
...
![Image 4](https://techcrunch.com/wp-content/uploads/2025/10/GettyImages-2235448056.jpg?w=680)
...
While autonomous vehicles and robotics are obvious use cases for physical AI that will no doubt continue to grow in 2026, the training and deployment required is still expensive. Wearables, on the other hand, provide a less expensive wedge with consumer buy-in. Smart glasses like the [Ray-Ban Meta](https://techcrunch.com/2025/12/16/metas-ai-glasses-can-now-help-you-hear-conversations-better/) are starting to ship assistants that can answer questions about what you’re looking at, and new form factors like [AI-powered health rings](https://ouraring.com/blog/oura-advisor/) and [smartwatches](https://www.apple.com/newsroom/2025/09/apple-debuts-apple-watch-series-11-featuring-groundbreaking-health-insights/) are normalizing always-on, on-body inference.
...
| 项目 | 信息 |
|------|------|
| **原文链接** | [点击查看](https://techcrunch.com/2026/01/02/in-2026-ai-will-move-from-hype-to-pragmatism/) |
